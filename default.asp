...
<head>
    ...
    <meta property="og:image" content="static/images/site/og-image.png">
    <style>
                ...
                <div class="exact">
                    <div class="result" onclick="location.href='word.asp?id=<%=res("id")%>';">
                        <div class="heb" style="position: relative;">
                            ...
                            <span class="icons"><%
                            if res("mediaID") then %>
                                <img src="static/images/site/audio.png" alt="לערך זה יש סרטון או אודיו" title="לערך זה יש סרטון או אודיו" class="audio"/><%
                            end if
                            Select Case res("status")
                            Case 1 %>
                                <img src="static/images/site/correct.png" id="ערך זה נבדק ונמצא תקין" alt="ערך זה נבדק ונמצא תקין" title="ערך זה נבדק ונמצא תקין" class="correct" /><%
                            Case -1 %>
                                ...
                                <div class="heb" style="position: relative;"><a href="word.asp?id=<%=res2("id")%>"><%=res2("hebrewTranslation")%></a><%
                                    ...
                                    <span class="icons"><%
                                        if len(res2("imgLink"))>0 then %>
                                            <img src="static/images/site/photo.png" alt="לערך זה יש תמונה" title="לערך זה יש תמונה" class="imgLink" /><%
                                        end if
...
<div id="madrasa-welcome">
    <div class="madrasa-welcome-img">
        <a href="https://madrasafree.com" target="_blank">
            <img src="/static/images/site/madrasa.png" alt="Madrasa's logo" width="120">
        </a>
    </div>
...
<div id="boxMenu">
    ...
    <div >
        ...
        פורטל ערבית מדוברת
        <img style="height:100%;opacity:1;" src="static/images/site/logo.png"/>
        </div></a>
    </div>
</div>
