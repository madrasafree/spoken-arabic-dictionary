...
If session("role") <> 15 then
	...
	Response.Redirect "labelControl.asp"
end If
...
'openDB "arabicWords"
openDbLogger "arabicWords","O","labelNew.insert.asp","single",""
...
'closeDB
closeDbLogger "arabicWords","C","labelNew.insert.asp","single",durationMs,""
