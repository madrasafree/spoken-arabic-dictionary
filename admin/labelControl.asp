...
<div class="view">
    <a href="index.asp">חזרה לדף ניהול ראשי</a>
    <h2>ניהול נושאים</h2><%


'openDB "arabicWords"
openDbLogger "arabicWords","O","labelControl.asp","single",""
    ...
    <div style="display:table; text-align:right; border:2px solid gray; padding: 10px; margin:0 auto; min-width: 300px;">
        ...
        do until res.EOF %>
    	    <div class="trow">
                <div class="edit"><a href="labelEdit.asp?id=<%=res("id")%>">ערוך</a></div>
...
'closeDB
closeDbLogger "arabicWords","C","labelControl.asp","single",durationMs,""


%>
<form action="labelNew.insert.asp">
