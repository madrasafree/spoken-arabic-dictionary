...
'openDB "arabicUsers"
openDbLogger "arabicUsers","O","userEdit.asp","single",""
...
<form action="userEdit.update.asp" method="post" >
...
<br />
    ...
    <br /><br /><a href="index.asp">חזרה לדף שליטה</a>
</form><%
'closeDB
closeDbLogger "arabicUsers","C","userEdit.asp","single",durationMs,""
