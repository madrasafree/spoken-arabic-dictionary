...
<!--#include virtual="/includes/time.asp"--><%
  ...
  if unlockWord="true" then
    ...
    'openDB "arabicWords"
    openDbLogger "arabicWords","O","locked.asp","unlock","" 
    ...
    'closeDB
    closeDbLogger "arabicWords","C","locked.asp","unlock",durationMs,"" 'inc.asp 
...
'openDB "arabicWords"
openDbLogger "arabicWords","O","locked.asp","read","" 
...
do until res.EOF %>
    <tr>
        ...
        <td style="text-align:center;"><a href="locked.asp?unlock=true&id=<%=res("id")%>">unlock</td>
    </tr><%
    res.moveNext
loop
res.close 
...
'closeDB
closeDbLogger "arabicWords","C","locked.asp","read",durationMs,"" 'inc.asp %>
