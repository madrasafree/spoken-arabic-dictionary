...
startTime = timer()
'openDB "arabicWords"
openDbLogger "arabicWords","O","team/edit.asp","permission",""
...
'closeDB
closeDbLogger "arabicWords","C","team/edit.asp","permission",durationMs,""




if ok=false then Response.Redirect "login.asp" 


startTime = timer()
'openDB "arabicWords"
openDbLogger "arabicWords","O","team/edit.asp","lock",""
...
durationMs = Int((endTime - startTime)*1000)
'closeDB
closeDbLogger "arabicWords","C","team/edit.asp","lock",durationMs,""
...
<!--#include file="inc/header.asp"-->
    ...
    <link rel="stylesheet" href="inc/edit.css?v1" />
    <script src="js/jquery.new.edit.js"></script> <!-- THIS HAS THE JSON CODE-->
</head>
<!--#include file="inc/functions.asp"-->
<body>
...
<div id="page">
    ...
    <form action="edit.update.asp?id=<%=wordID%>" method="post" id="edit" name="edit">
    <input type="HIDDEN" id="wordID" value="<%=wordID%>"><%


    startTime = timer()
    'openDB "arabicWords"
    openDbLogger "arabicWords","O","team/edit.asp","word details",""
    ...
    durationMs = Int((endTime - startTime)*1000)
    'closeDB
    closeDbLogger "arabicWords","C","team/edit.asp","word details",durationMs,""
