...
<head>
    ...
    <script>
        ...
        $(function(){
        $("#msgBoard").load("msg"+getRndInt(1,3)+".html?version=8"); 
        });
...
<div class="box">
    ...
    <div id="msgRsltsNoneShort" style="text-align: center; padding: 5px; background: #ffd7d73d; border-bottom: 2px solid #ff8282; margin: 0 auto; color: #ff8282;">
        <p style="font-weight:bold;">
            לא עלו תוצאות
        </p>
        יש מעט מאוד מילים קצרות כל כך במילון
        <p style="padding:20px; max-width:300px; margin:0 auto; font-size:small;">
            אם אתם בטוחים שהמילה הזו אמורה להופיע במילון, פנו אלינו כדי שנוסיף אותה - arabic4hebs@gmail.com
        </p>
    </div><%
...
if len(strClean)=0 then
    ...
    <div style="min-width:320px; max-width:440px; margin:50px auto;">
        ...
        <!-- משבצת פירסום - תוצאות חיפוש -->

        <!-- CUSTOM AD (ACTIVE)-->
        <!--#include file="inc/ads/2021-08_002-finjan.asp"-->
...
If len(strDisplay)=0 then %>
    ...
    <div style="min-width:320px; max-width:440px; margin:50px auto;">
        ...
        <!-- משבצת פירסום - דף נחיתה -->

        <!-- CUSTOM AD (ACTIVE) -->
        <!--#include file="inc/ads/2021-08_003-lingolearn.asp"-->
