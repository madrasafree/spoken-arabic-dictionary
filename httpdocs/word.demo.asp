...
<main class="flex-container">
    <section class="sctRight">
        ...
        <div id="adMobile" class="h2" style="border:0; background:none;">
            ...
            <!--#include file="inc/ads/2021-00_Word_Video_Mockup.asp"-->
        </div>
...
<div class="table" style="margin:10px auto; text-align:center;">
    <span onclick="location.href='team/edit.asp?id=<%=wordID%>'" role="button" id="toolsClick">עריכה</span> | <span onclick="location.href='word.history.asp?id=<%=wordID%>'" role="button" id="historyClick"> היסטוריה </span>
</div>
