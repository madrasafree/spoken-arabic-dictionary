...
<ul style="max-width:600px; margin:0 auto;">
    ...
    <li><a href="TEST.shada.asp">שדה - בעיית התצוגה</a></li>
    <li><a href="TEST.ruby.asp">Ruby RT RP (HTML TAGS)</a></li>
    <li><a href="TEST.video.asp">וידאו</a></li>
    <li><a href="TEST.msgBoard.asp">msgBoard</a></li>
    ...
    <li><a href="TEST.videos.asp">דף מרכז לסרטונים שהכנו</li>
...
<ul style="max-width:600px; margin:0 auto;">
    ...
    <li><a href="TEST.json.asp">json</a></li>
    ...
    <li><a href="TEST.paypal.asp">paypal</a></li>
    ...
    <li>לייבא טסטים מתוך תיקיית TEAM</li>
