...
<div id="pTitle">ברוכים הבאים</div>
    <div style="max-width:500px;margin:0 auto;">
        ...
        <fieldset>
            <ul>
                <li>מכל מקום באתר, לחצו על האייקון הכתום בסרגל התחתון <img style="max-width:20px;" src="static/images/team/teamLogo.png" alt="t"/></li>
        ...
        <fieldset>
            ...
            <ul>
                <li>מכל מקום באתר, לחצו על האייקון + בסרגל התחתון <img style="max-width:20px;" src="static/images/site/add-square.png" alt="+"/></li>
